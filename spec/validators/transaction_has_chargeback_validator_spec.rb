...
RSpec.describe TransactionHasChargebackValidator do
  describe 'TransactionHasChargebackValidator valid true' do
    let(:transaction) do
  ...
  describe 'TransactionHasChargebackValidator valid false' do
    let!(:transaction) do
