...
RSpec.describe TransactionAmountPeriodValidator do
  describe 'TransactionAmountPeriodValidator valid true' do
    let(:transaction) do
      { transaction_attributes: { request_transaction_id: 2_342_357, merchant_id: 29_744, user_id: 97_051,
                                  card_number: '434505******9116', transaction_date: '2019-11-31T21:16:32.812632',
  ...
  describe 'TransactionAmountPeriodValidator valid false' do
    let!(:transaction) do
      Transaction.create(request_transaction_id: 2_342_357, merchant_id: 29_744, user_id: 97_051,
                         card_number: '434505******9116', transaction_date: '2019-11-31T22:16:32.812632',
                         transaction_amount: 373, device_id: 285_475, has_cbk: true)
    end
